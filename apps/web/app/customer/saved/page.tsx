...
const savedTours = [
  ...
  {
    id: "3",
    image: "/bookings/saint-martin.jpg",
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
      ...
      <div className="flex items-center justify-between pt-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Saved Tours</h1>
          <p className="text-sm text-gray-500">Your wishlist of tours to book later</p>
        </div>
      </div>
