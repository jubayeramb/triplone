      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {filteredCustomers.map((customer) => (
          <Card key={customer.id} className="relative">
            <CardContent className="p-6">
              {/* Menu Button */}
              <button className="hover:bg-muted absolute right-4 top-4 rounded p-1">
              ...
              <div className="mb-4 flex items-start gap-3">
                <Avatar className="h-12 w-12">
                  <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-orange-400 to-pink-500 text-lg font-semibold text-white">
              ...
              <div className="text-muted-foreground mb-4 space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    {customer.location} • {customer.favoredTour}
                  </span>
                </div>
                <div className="flex items-center gap-2">
