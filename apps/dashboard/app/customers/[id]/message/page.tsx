...
export default function CustomerMessagePage() {
  ...
  const renderComposeView = () => (
    <Card>
      <CardContent className="p-6">
        <h2 className="mb-6 text-xl font-bold">New Message</h2>
        ...
        <div className="mb-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {(["email", "sms", "whatsapp"] as CommunicationChannel[]).map(
              (channel) => (
                <button
                  key={channel}
  ...
  const renderHistoryView = () => (
    <Card>
      <CardContent className="p-6">
        <h2 className="mb-6 text-xl font-bold">Message History</h2>
